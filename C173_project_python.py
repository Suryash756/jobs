...
selected_ITLabel=Label(root)
selected_ITLabel.place(relx=0.01, rely=0.6,anchor=W)
...
class parent():
    ...
    def softwareEngineer(it_professional_name):
        ...
        selected_ITLabel["text"]= it_professional_name+" has been alloted to "+IT_company_list[random_IT_company]
        
    def chemicalEngineer(chemical_engineer_name)  :
        company_list=["DUPONT","CORTEVA","ONGC"]
